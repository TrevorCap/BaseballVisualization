d3.json("/deathYear", function(error, playerData) {
    ...
    // log a list of player death years to test
  ...
  L.tileLayer("https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token={accessToken}", {
    ...
    for (var i = 0; i < playerData.length; i++) {
        ...
        //This is where we ADD what info we want displayed plus html tags to style info
          ...
          playerData[i][2] + "</h8>" + "</h7><hr>" + "<h7>" + "Death Place: " + 
          "</h7>" + "<h8>" + playerData[i][8] + ", " + playerData[i][9] +
          "<img  style='max-width:75px' src=" + playerData[i][7] + " ></img></h8><hr>" + 
          "<h7>" + "Death Year: " + "<h8>" + playerData[i][6] + "</h8></p>"));
      }
